...
describe("DataFrame Join (Inner)", () => {
  it("should return an empty DataFrame if there are no matching records for inner join", () => {
  ...
  it("should perform an inner join with multiple entries in source and one matching entry in target", () => {
  ...
  it("should perform inner join with one entry in source and multiple matching entries in target", () => {
  ...
  it("should merge DataFrames (Inner Join) multiple matching enteries in both source and target", () => {
    const sourceDataFrame = new DataFrame([
      { id: 1, name: "John" },
      { id: 2, name: "Jane" },
      { id: 3, name: "Jim" },
